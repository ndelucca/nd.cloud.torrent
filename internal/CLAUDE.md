...
- Byte sizes are **base 1000**, matching `web.humanBytes`. The two disagreed — this one binary, the UI decimal — so one download was logged as 954MB and displayed as 1.0 GB. A log that contradicts the screen is worse than either convention.
